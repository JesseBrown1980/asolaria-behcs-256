...
function manifest() {
  return {
    id: "phone_pro_mirror",
    version: "1.0.0",
    description: "Scrcpy-based live phone mirroring — start/stop/status management with PID tracking and device auto-selection",
    capabilities: ["start_mirror", "stop_mirror", "status_check", "device_auto_select"],
    readScopes: ["scrcpy_status", "adb_devices", "pid_file"],
    writeScopes: ["scrcpy_process", "pid_file"],
    approvalRequired: false,
    healthCheck: false,
    retrySemantics: "none",
    timeoutMs: 15000,
    secretRequirements: [],
    sideEffects: ["launches scrcpy as detached process", "writes PID file to logs directory", "kills scrcpy process on stop"],
    failureModes: ["scrcpy_not_found", "scrcpy_start_failed", "no_authorized_phone_device", "kill_error"],
    emittedEvents: ["phone_pro_mirror.started", "phone_pro_mirror.stopped"]
  };
}
